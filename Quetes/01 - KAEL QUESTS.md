...
- **L'embuscade** - Une unité ennemie "plus faible" termine son tour dans votre ZoC avec une unité "plus forte".
- **Le piège** - Gagnez une bataille contre un ennemi en terrain difficile (sans être vous même en terrain difficile)
- **La manoeuvre** - Triangulez une unité ennemie, entourez la de ZoC pour l'immobiliser ou la forcer à attaquer
- **Le Siege** - Affamez une ville d'un autre joueur (positionnez 3 forts au moins dans sa zone de production)
- **Repousser** - Faites reculer une unité ennemie dans un combat
- **Le renfort à temps** - Faites arriver une unité avec moral >50 sur une unité avec moral <=10 qui as un ordre d'attaque vers elle
- **La bataille impossible** - Gagnez un affrontement contre une unité qui a plus de défense que votre attaque, en utilisant le terrain pour avoir autant
- **Le marteau et l'enclume** - Contrôlez deux territoires séparés par un territoire ennemi.
- **La pointe** - Capturer un territoire a plus de 400 cases de votre capitale, et qui n'est pas relié à votre teritoire existant
- **Le front étiré** - Maintenez une frontière de 30 cases avec un autre empire. Collée.
- **Le fer de lance** - Faites pénétrer une armée au-delà de 20 cases à l'intérieur du territoire adverse.
...
- **Le dernier rempart** - Fortifiez un territoire puis survivez à une attaque ennemie.
- **Chasse au convoi** - Interceptez une unité ennemie transportant des ressources.
- **Terre brûlée** - Conquérez un territoire puis détruisez vous-même une infrastructure qui ne vous est plus utile.
- **Guerre éclair** - Conquérez plusieurs territoires ennemis avant que votre armée ne retourne en ville.
- **Le passage** - Prenez le contrôle d'une zone permettant de relier deux parties de votre empire.
- **À découvert** - Gagnez une bataille alors que votre armée est loin de toute ville alliée.
- **Couper la route** - Interrompez une ligne logistique ennemie en contrôlant un point stratégique.
- **Contre-attaque** - Perdez un territoire puis reprenez-le au même joueur.
- **Le prix de la victoire** - Gagnez une bataille avec une armée ayant subi des pertes significatives.
- **Conquête** - Conquérez 50 cases appartenant à un autre joueur.
- **Tête de pont** - Établissez une position militaire à au moins 30 cases de votre territoire.
- **Briser la ligne** - Remportez une bataille contre une armée supérieure en nombre.
- **Maîtrise du terrain** - Remportez une bataille en terrain défavorable.
- **Campagne lointaine** - Faites combattre une armée à plus de 100 cases de votre capitale.
- **Défense acharnée** - Défendez avec succès un territoire puis reprenez une case perdue.
- **Projection de puissance** - Contrôlez 200 cases dans une zone située loin de votre cœur territorial.
- **Guerre de mouvement** - Remportez plusieurs batailles avec la même armée sans la ramener en ville.
- **Grande offensive** - Conquérez 100 cases au cours d'une même campagne.
- **Rival** - Prenez le contrôle d'un territoire appartenant à un joueur mieux classé que vous.
...
- **Le territoire ennemi** - À la fin du cycle, contrôlez au moins 100 cases qui appartenaient à un autre empire.
- **La guerre sans fin** - Remportez au moins 5 batailles contre 3 joueurs différents.
- **L'invasion** - Possédez une armée à plus de 100 cases de votre territoire principal pendant 24h.
- **Le briseur d'empires** - Réduisez de 20 % le territoire d'un adversaire pendant le cycle.
- **La revanche** - Reprenez au moins 50 cases perdues face à un autre joueur.
- **Le front** - Maintenez une frontière avec un autre empire pendant toute la durée du cycle.
- **La conquête impossible** - Conquérez un territoire dont la surface initiale est supérieure à la vôtre.
- **Le prédateur** - Attaquez trois joueurs différents sans perdre votre propre capitale.
