...
## Règles de territoires
 - On conquiert des terrain en fondant une ville ou un fort.
 - Un territoire est un ensemble de cases adjacente possédées par le même joueur
 - Un territoire est perdu si il n'y a aucune occupation militaire sur celui-ci
