...
______
## Pitch
Klod Online est un **jeu de stratégie massivement multijoueur** basé sur des **tours synchronisés toutes les 5 minutes**. Chaque joueur incarne un empire indépendant, qui évolue dans un monde commun persistant, généré de façon procédurale, et composé d'hexagones. Ils peuvent choisir de se faire la guerre, de coopérer, ou d'extraire des ressources plus ou moins rares.

## État actuel
Le moteur de jeu principal est fonctionnel : monde hexagonal procédural, gestion des villes et unités, combats, diplomatie bilatérale, zones de contrôle, système d'inventaire, production de ressources, construction de bâtiments, recrutement, artisanat, et IA barbare. Le jeu tourne sur un serveur de jeu avec une interface web et un chat en temps réel.
...
Au-delà du gameplay classique des 4X on trouvera comme innovations principales :
 ...
 - Une gestion des villes où chaque ville peut se **_spécialiser_** avec un arbre de technologie.
 - Un terrain qui peut être **_modifié_** par les joueurs (routes, irrigations, canaux)
 - Un système de _**missions individualisées**_ permettant aux joueurs de jouer la diplomatie fine s'ils le souhaitent. _(non implémenté)_
